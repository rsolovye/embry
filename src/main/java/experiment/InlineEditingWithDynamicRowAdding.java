...
//
//    private final ObservableList<VitrifiedEmbryo> vitrifiedEmbryoObservableList = new VitrifiedEmbryoService().getVitrifiedEmbryosList();
//
//
//    private TableView<VitrifiedEmbryo> table;
//
//    @Override
//    public void start(Stage stage) {
//
//        // create edtiable table
//        table = new TableView<VitrifiedEmbryo>();
//        table.setEditable(true);
//
//        // column 1
//        TableColumn<VitrifiedEmbryo, String> strawNumber = new TableColumn<>("№ соломины");
//        strawNumber.setMinWidth(100);
//        strawNumber.setCellValueFactory( cellData -> cellData.getValue().get("strawNumber"));
//        strawNumber.setCellFactory(createStringCellFactory());
//
//        // column 2
//        TableColumn<VitrifiedEmbryo, String> embryoNumber = new TableColumn<>("№ соломины");
//        strawNumber.setMinWidth(100);
//        strawNumber.setCellValueFactory( cellData -> cellData.getValue().get("embryoNumber"));
//        strawNumber.setCellFactory(createStringCellFactory());
//
//
//        TableColumn<VitrifiedEmbryo, String> strawNumber = new TableColumn<>("№ соломины");
