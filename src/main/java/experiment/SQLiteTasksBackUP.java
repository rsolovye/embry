...
public class SQLiteTasksBackUP extends Application {
    private static final Logger logger = Logger.getLogger(SQLiteTasksBackUP.class.getName());
...
private void fetchNamesFromDatabaseToListView(
    ...
    public static Connection getConnection() throws ClassNotFoundException, SQLException {
        ...
        return DriverManager.getConnection("jdbc:sqlite:H2-test.db");
    }
